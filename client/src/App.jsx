...
function PageView(props) {
  ...
  return <WorkspaceSettingsPage session={props.session} setCredits={props.setCredits} adminAccess={adminAccess} notify={props.notify} />;
}
...
function WorkspaceSettingsPage({ session, setCredits, adminAccess, notify }) {
